...
function openGmail() {
  const email = "rudrakshnagda27@gmail.com";
...
function downloadCV() {
  ...
  link.href = "Rudraksh Nagda Resume.pdf"; // Path to your resume file
  link.download = "Rudraksh Nagda Resume"; // Name for the downloaded file
